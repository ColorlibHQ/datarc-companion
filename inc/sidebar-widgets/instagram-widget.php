...
class datarc_instagram_widget extends WP_Widget {
...
'datarc_instagram_widget',


// Widget name will appear in UI
esc_html__( 'Instagram Widget', 'datarc' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer instagram widget.', 'datarc' ), ) 
);
...
<ul class="instafeed d-flex flex-wrap">
	...
	foreach( $items as $item ){
		...
		echo '<li><img src="'.esc_url( $imgurl ).'" alt="'.esc_attr( datarc_image_alt( $imgurl ) ).'"></li>';
	}
	?>
</ul>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'INSTAFEED', 'datarc' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'itemnumber' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'datarc'); ?></label> 
...
function datarc_instagram_load_widget() {
	register_widget( 'datarc_instagram_widget' );
}
add_action( 'widgets_init', 'datarc_instagram_load_widget' );